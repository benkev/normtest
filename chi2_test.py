...
Nf = 100000     # Number of frames to read
...
q0 = np.fromfile("bin_leonid2/nt_hist_cuda_" + fbase +
...
pl.figure()
pl.grid(1)
pl.hist(c2.flatten(),  100, label="$\chi^2$")
pl.hist(c2r.flatten(), 100, label="Reduced: $\chi^2$/$\mathrm{df}$")
...
# pl.figure();
# pl.plot(y, chi2.isf(y, 2)); pl.grid(1)
# pl.plot(pval, chi2.isf(pval, 2), 'r.')
