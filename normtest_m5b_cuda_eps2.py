...
#
# Requires:
# ker_m5b_gauss_test_eps2.cu, CUDA kernel.
#
# Usage: 
# $ python normtest_m5b_cuda_eps2.py <m5b-file-name> [<# of threads per block>]
#                                    [-s]
#
# Or, from IPython:
#
...
#
kernel = "ker_m5b_gauss_test_eps.cu"
