...
equal-area bins by the vertical lines at $-\theta_{cr} = -0.6745$, 0, and $\theta_{cr} = +0.6745$. The mathematical expectations of the bins, $\mu_1=\pm 0.32$ and $\mu_2=\pm 1.27$ are indicated with red dots. See Addendum, Fig.~\ref{bins_25_pc}. \par
\hangindent=1cm \hangafter=1
